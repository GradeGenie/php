...
<head>
    ...
    <title>Grady AI - Bulk Grading</title>
...
<body>
    ...
    <div id="mainContent">
        <div class="container">
            ...
            <div class="section" id="createAssignmentSection">
                <h2>Create Assignment</h2>
                <form id="assignmentForm">
                    <div class="form-group">
                        <label for="assignmentTitle">What's this Assignment called?</label>
            ...
            <div class="section hidden" id="uploadSection">
                ...
                <form id="uploadForm" action="upload_assignments.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="section hidden" id="rubricSection">
                ...
                <form id="rubricForm" action="select_rubric.php" method="POST">
                    <div class="form-group">
