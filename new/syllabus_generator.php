    ...
    <div id="mainContent" class="container">
        ...
        <div id="generate" class="tab-content active">
            ...
            <form id="generationForm">
                ...
                <div class="actions">
                    <button type="button" id="backToDetailsBtn" class="btn btn-outline">Back to Details</button>
        ...
        <div id="edit" class="tab-content">
            ...
            <form id="editForm">
                ...
                <div class="actions">
                    <button type="button" id="backToGenerateBtn" class="btn btn-outline">Back to Generate</button>
        ...
        <div id="preview" class="tab-content">
            ...
            <div class="actions">
                <button type="button" id="backToEditBtn" class="btn btn-outline">Back to Edit</button>
                <div>
