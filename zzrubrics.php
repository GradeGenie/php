<?php
echo password_hash('JustGradeIt', PASSWORD_DEFAULT);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Genie AI - Create Rubric</title>
...
<body>
    ...
    <div id="mainContent">
        ...
        <div id="rubric-result" class="container" style="display:none;">
            ...
            <div id="message">
                Copy your Rubric over to Google Docs or Word to modify it. Later, upload it into the bulk grader to grade hundreds of assignments at once!
                <button onclick="copyRubric('rubric-table');" class="copyBtn">Copy Rubric</button>
            </div>
