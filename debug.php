    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    <td>APP_ENV</td>
                    <td><?php echo htmlspecialchars(env('APP_ENV', 'missing')); ?></td>
                </tr>
                <tr>
                    <td>DB_HOST</td>
                    <td><?php echo htmlspecialchars(env('DB_HOST', 'missing')); ?></td>
                </tr>
                <tr>
                    <td>DB_NAME</td>
                    <td><?php echo htmlspecialchars(env('DB_NAME', 'missing')); ?></td>
                </tr>
                <tr>
                    <td>Stripe key set?</td>
                    <td><?php echo env('STRIPE_SECRET_KEY') ? 'yes' : 'no'; ?></td>
                </tr>
            </table>
            <p class="warning">Delete this page before going live.</p>
        </div>
